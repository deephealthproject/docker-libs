...
if [ -z "${GPU_RUNTIME}" ]; then
    ...
    python3 examples/NN/1_MNIST/mnist_conv.py --gpu --small --epochs 1
    python3 examples/NN/1_MNIST/mnist_losses.py --gpu --small --epochs 1
    python3 examples/NN/1_MNIST/mnist_mlp_da.py --gpu --small --epochs 1
    python3 examples/NN/1_MNIST/mnist_mlp_initializers.py --gpu --small  --epochs 1
    python3 examples/NN/1_MNIST/mnist_mlp.py --gpu --small --epochs 1
    python3 examples/NN/1_MNIST/mnist_mlp_regularizers.py --gpu --small --epochs 1
    python3 examples/NN/1_MNIST/mnist_mlp_train_batch.py --gpu --small --epochs 1
    python3 examples/NN/1_MNIST/mnist_rnn.py --gpu --small --epochs 1

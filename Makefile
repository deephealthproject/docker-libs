...
DOCKER_NVIDIA_DEVELOP_IMAGE := $(or ${DOCKER_NVIDIA_DEVELOP_IMAGE},nvidia/cuda:11.3.1-devel-ubuntu18.04)
DOCKER_NVIDIA_RUNTIME_IMAGE := $(or ${DOCKER_NVIDIA_RUNTIME_IMAGE},nvidia/cuda:11.3.1-runtime-ubuntu18.04)
DOCKER_CUDNN_DEVELOP_IMAGE := $(or ${DOCKER_CUDNN_DEVELOP_IMAGE},nvidia/cuda:11.3.1-cudnn8-devel-ubuntu18.04)
DOCKER_CUDNN_RUNTIME_IMAGE := $(or ${DOCKER_CUDNN_RUNTIME_IMAGE},nvidia/cuda:11.3.1-cudnn8-runtime-ubuntu18.04)
